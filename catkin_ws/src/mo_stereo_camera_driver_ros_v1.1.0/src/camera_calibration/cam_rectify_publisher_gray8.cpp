...
//     // 發布左右眼原始 Bayer（16UC1）
//     ros::Publisher pubLeft  = nh.advertise<sensor_msgs::Image>("/mo_camera/left/image_rect",  1);
//     ros::Publisher pubRight = nh.advertise<sensor_msgs::Image>("/mo_camera/right/image_rect", 1);
