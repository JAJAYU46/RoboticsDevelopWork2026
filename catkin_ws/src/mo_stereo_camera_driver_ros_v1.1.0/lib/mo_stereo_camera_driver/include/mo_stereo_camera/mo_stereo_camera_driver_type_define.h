...
typedef struct _mo_imu_data_set_s {
    ...
    double dAccelX;  // meter per second
    double dAccelY;  // meter per second
    double dAccelZ;  // meter per second

    double dGyroX;  // rad per second
    double dGyroY;  // rad per second
    double dGyroZ;  // rad per second
} mo_imu_data;
